...
abstract class Shape {
    ...
    public String toString() {
		return String.format("%s:[x=%d,y=%d,w=%d,h=%d,mw=%d,mh=%d,c=%s,area=%.0f,text=%s]", this.getClass().getName(), x,y,width,height,marginWidth,marginHeight,color,getArea(),getText());
	}
