...
public class A3  extends JFrame {
	...
	class MyTreeSelectionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			Object sp = tree.getLastSelectedPathComponent();
			if (sp != null) {
	...
	class RemoveActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (panel.isRoot((Shape) LastPath)) {
				...
				panel.removeNodeFromParent((Shape) LastPath);
			}
		}
	}
	...
	class AddActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			Object LastPath = tree.getLastSelectedPathComponent();
			if (LastPath instanceof NestedShape) {
				panel.addShapeNode((NestedShape) LastPath);
			} else if (!(LastPath instanceof NestedShape)) {
